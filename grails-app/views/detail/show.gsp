...
<html>
    ...
    <body>
        ...
        <div id="show-detail" class="content scaffold-show" role="main">
            ...
            <f:display bean="detail" />
            <g:form resource="${this.detail}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.detail}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
